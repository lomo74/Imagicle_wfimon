...
static LPTSTR szGPL =
	_T("WFIMON - Imagicle print2fax port monitor\n")
	_T("Copyright (C) 2021 Lorenzo Monti\n")
	_T("\n")
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	minfo.pName = _T("Imagicle print2fax port monitor");
	minfo.pEnvironment = NULL;
	minfo.pDLLName = _T("wfimon.dll");
	...
	{
		DeleteMonitor(NULL, NULL, _T("Winfax for Imagicle Port Monitor"));
